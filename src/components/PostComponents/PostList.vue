<template>
  <v-card class="mx-auto" title="name" >
            ...
            >
              ...
              <v-card-actions>
                <v-list-item class="w-100">
                  ...
                  <v-list-item-title @click="FunC_writer(n)">writer {{n}}</v-list-item-title>

                  <v-list-item-subtitle @click="FunC_date(n)">date {{n}}</v-list-item-subtitle>
